...
Flanagan, David. JavaScript: The Definitive Guide (p. 244). O'Reilly Media. Kindle Edition. 

*/

/*

Example 9-8 is well commented and stands on its own. 

I encourage you to read it as a capstone example for this chapter on classes.
...
/**
 * The Abstract class defines a single abstract method, has()
 */
...
class BitSet extends AbstractWritableSet{
    ...
    // Iterate teh set by just checking each bit in turn.
...
// Some pre-computed values used by the has(), inser(), and remove() methods
