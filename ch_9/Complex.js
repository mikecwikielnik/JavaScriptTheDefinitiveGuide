...
Flanagan, David. JavaScript: The Definitive Guide (p. 235). O'Reilly Media. Kindle Edition. 
...
imaginary number and that the imaginary number i is teh square root of -1.
...
class Complex {
    ...
    // of complex numbers. If c and d are instances of this calss, we
    // might write c.plus(d) or d.times(x)
    plus(that){
